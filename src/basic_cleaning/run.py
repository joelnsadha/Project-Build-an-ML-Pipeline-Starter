...
def go(args):
    ...
    run = wandb.init(
        project="nyc_airbnb", group="basic_cleaning", job_type="basic_cleaning"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_type",
        type=str,  ## INSERT TYPE HERE: str, float or int,
        help="Cleaning dataset",  ## INSERT DESCRIPTION HERE,
        required=True,
    )
    ...
    parser.add_argument(
        "--output_description",
        type=str,  ## INSERT TYPE HERE: str, float or int,
        help="Description of the artifact.",  ## INSERT DESCRIPTION HERE,
        required=True,
    )
